...
// Mock Roles
export const mockRoles: Array<Role> = [
  {
    id: "role-owner",
    name: "Owner",
    color: "#ff6b6b",
...
// Mock Channels
export const mockChannels: Array<Channel> = [
  {
    id: "channel-1",
    name: "general",
    serverId: "server-1",
...
// Mock Server Members
export const mockServerMembers: Array<ServerMember> = [
  {
    userId: "user-1",
    serverId: "server-1",
    user: mockUsers[0]!,
...
// Mock Invitations
export const mockInvitations: Array<ServerInvitation> = [
  {
    id: "inv-1",
    serverId: "server-1",
